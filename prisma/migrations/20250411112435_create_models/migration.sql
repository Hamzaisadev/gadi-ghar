...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Gadi Ghar',
    "address" TEXT NOT NULL DEFAULT 'Clifton Block 8 ,Karachi , Pakistan',
    "phone" TEXT NOT NULL DEFAULT '03343149433',
    "email" TEXT NOT NULL DEFAULT 'hamzaisadev@gmail.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
