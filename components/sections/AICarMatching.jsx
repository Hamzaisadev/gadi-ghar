          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
              ...
              <div className="relative">
                ...
                <div className="absolute -top-4 -left-4 bg-red-600 text-white rounded-xl shadow-lg p-3 border border-gray-100">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <p className="text-xs text-red-100 uppercase tracking-wide">AI Match</p>
                      <p className="font-semibold text-white text-sm">98% Accurate</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 order-1 lg:order-2">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-black mb-6">
                🔍 Let AI Match Your <span className="text-red-600">Dream Car.</span>
              </h2>
              <p className="text-gray-600 text-xl mb-6 leading-relaxed">
                Upload a photo or type the name — our smart system finds the closest matches instantly. It's fast, easy, and surprisingly accurate.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-black mb-1">Photo Recognition</h3>
                    <p className="text-gray-600 text-sm">Upload any car image for instant identification</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="font-semibold text-black mb-1">Lightning Fast</h3>
                    <p className="text-gray-600 text-sm">Get results in under 3 seconds</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="font-semibold text-black mb-1">Precise Matching</h3>
                    <p className="text-gray-600 text-sm">Advanced AI identifies make, model, and year</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="font-semibold text-black mb-1">Smart Suggestions</h3>
                    <p className="text-gray-600 text-sm">Find similar cars and better alternatives</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <p className="font-semibold text-black">Powered by Advanced Machine Learning</p>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Our AI has been trained on millions of car images and constantly learns from our extensive database to deliver the most accurate matches in the industry.
                </p>
              </div>
            </div>
          </div>
