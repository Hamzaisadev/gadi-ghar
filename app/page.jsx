        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Extensive Inventory</h3>
              <p className="text-gray-600">
                A diverse range of vehicles from reputable dealers and private
                sellers.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Schedule your test drive effortlessly online, with various time
                slots available.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Enjoy peace of mind with verified listings and a secure booking
                process.
              </p>
            </div>
          </div>
